...
SRCS = src/main.c src/gameboy.c src/memory.c src/cartridge.c src/instructions/cpu_instructions.c src/instructions/cpu_load.c src/instructions/cpu_arithmetic.c src/instructions/cpu_logic.c src/tests.c
OBJ = $(SRCS:.c=.o)
OUT = gb
